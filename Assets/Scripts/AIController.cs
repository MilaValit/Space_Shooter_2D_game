...
namespace SpaceShooter
{
    ...
    public class AIController : MonoBehaviour
    {
        ...
        private void UpdateAI()
        {
            ...
            if (m_AIBehaviour == AIBehaviour.PatrolRoute)
            {
                UpdateBehaviourPatrol();
            }
        }
        ...
        private void ActionFindNewMovePosition()
        {
            if (m_AIBehaviour == AIBehaviour.Patrol)
            {
                ...
                {
                    m_MovePosition = m_SelectedTarget.transform.position + offset;
                }
                else
                {
                    if (m_PatrolPoint != null)
                    {
                        ...
                        {
                            m_MovePosition = m_PatrolPoint.transform.position + offset;
                        }
                    }
                }
            }
            ...
            if (m_AIBehaviour == AIBehaviour.PatrolRoute)
            {
                transform.position = Vector3.MoveTowards(transform.position, wayPoints[currentWayPointIndex].position, m_NavigationLinear * Time.deltaTime);
